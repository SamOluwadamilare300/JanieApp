...
import { useQueryAutomationPosts } from '@/hooks/user-querie'
import TriggerButton from '@/components/global/trigger-button'
import Loader from '@/components/global/loader'
import { InstagramPostProps } from '@/types/post.types'
